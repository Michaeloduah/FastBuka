              ...
              <div class="col-md-8">
                ...
                <div class="hero-button text-center">
                  <a href="#" class="text-decoration-none">
                    <button class="btn button1">Sign for up free</button>
                  </a>
                  <a href="#" class="text-decoration-none">
      ...
      <main id="main">
        ...
        <section class="hygiene">
          <div class="container hygiene-content" data-aos="zoom-in">
            <img
              src="./assets/images/Food_and_flower.png"
              alt=""
            ...
            <div class="row hygiene-write">
              ...
              <div class="col-md-6 col-sm-12 p-5 sm-p-3">
                ...
                <a href="#" class="text-decoration-none"
                  ><button class="btn hygiene-btn">See Menu</button></a
                >
              </div>
            </div>
          </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="mt-5 mx-2">
                      <div class="food-card">
                        <div
                          style="background-color: #d2e8ff; border-radius: 20px"
                        >
                          ...
                          <img
                            ...
                            class="img-fluid d-block mx-auto py-3"
                            alt=""
                          />
                        </div>
            ...
            <div class="filter row">
              <div class="price-range col-md-4 col-12">
                <div class="range_container">
                  ...
                  <input
                    class="form-control form_control_container__time__input"
                    type="number"
                    id="fromInput"
                    value="2000"
                    min="1000"
              ...
              <div class="search col-md-4 col-12">
                <form action="">
                  <div class="input-group mb-3">
                    ...
                    />
                    <button
                      class="btn btn-sm btn-outline-success mx-1 border b-0"
                    >
                      Search
                    </button>
                  </div>
              ...
              <div class="col-md-4 col-12">
                <div class="d-flex justify-content-between">
                  ...
                  <select
                    class="form-select my-auto border border-0"
                  ...
                  <select
                    class="form-select my-auto border border-0 w-25"
                    aria-label="Default select example"
                  >
          ...
          <div class="container">
            <div class="row mt-5">
              ...
              <div class="col-12 col-md-7">
                <p class="fw-normal text-black">To find out more about our products, offers and services or if you have any question, please get in touch.</p>
              </div>
            </div>
          </div>
        </section>
