    ...
    <div class="container">
        <div class="filter row">
            ...
            <div class="search col-md-4 col-12">
                <form action="{{ route('user.dashboard.food.search') }}">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="food-card shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                            <div style="background-color: #d2e8ff; border-radius: 20px">
                                ...
                                @endforeach --}}
                                <a href="{{ route('user.dashboard.food.details', $food->id) }}">
                                    <img src="{{ asset('storage/images/foods/' . $food->images[0]) }}" alt=""
                                        class="img-fluid d-block mx-auto py-3" style="height:200px" />
                                </a>
                            </div>
                            <div class="mt-2 d-flex">
                                <h1 class="fs-6 me-auto">{{ $food->name }}</h1>
                                <p><i class="bi bi-clock"></i> {{ $food->processing_time }} </p>
                            </div>
                            <p>
                                {{ $food->description }}
                            </p>
